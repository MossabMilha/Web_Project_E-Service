<nav class="bg-blue-50 border-b-blue-400 border-b-2 h-20 p-4 flex justify-between items-center">
    ...
    <div class="flex gap-6 items-center w-20 ">
        <a href=""><i class="flex justify-center items-center text-2xl text-blue-600 bi bi-bell"></i></a>
        <a href=""><i class="flex justify-center items-center text-2xl text-blue-600 bi bi-person-circle "></i></a>
    </div>
</nav>
